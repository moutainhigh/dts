...
package com.jkys.job.service.handler;
...
public class DemoGlueJobHandler extends IJobHandler {
	...
	public ReturnT<String> execute(String param) throws Exception {
		XxlJobLogger.log("ZYYH-JOB, Hello World.");
...
#!/usr/bin/env node
console.log("zyyh-job: hello nodejs")
...
Write-Host "zyyh-job: hello powershell"
